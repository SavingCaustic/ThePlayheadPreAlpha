...
std::unordered_map<std::string, ParamDefinition> EffectInterface::parameterDefinitions;

void EffectInterface::initializeParameters() {
    float valToLambda;
...
void EffectInterface::pushStrParam(const std::string &name, float val) {
...
void EffectInterface::setupCCmapping(const std::string &synthName) {
