    ...
    if (SynthBase::paramDefs.empty()) {
        ...
        SynthBase::paramDefs = {
            {UP::modwheel, {"modwheel", 0.0f, 0, false, 0, 1, [this](float v) {
                                modwheel = v;
                                if (mw_routing == MW::Routing::lfo1speed) {
                                    setLFO1speed();
                                }
                                if (mw_routing == MW::Routing::lfo2speed) {
                                    setLFO2speed();
                                }
                            }}},
            ...
            {UP::vca_rate_kt, {"vcf_rate_kt", 0.0f, 0, false, 0, 1, [this](float v) {
                                   vca_rate_kt = v;
                               }}},
            ...
            {UP::lfo2_speed, {"lfo2_speed", 0.5f, 0, true, 100, 9, [this](float v) {
                                  std::cout << "setting lfo2-speed (mHz) to " << v << std::endl;
                                  lfo2_speed = v;
                                  setLFO2speed();
                              }}},
            ...
            {UP::mw_routing, {"mw_routing", 0.0f, MW::Routing::_count, false, 0, MW::Routing::_count - 1, [this](float v) {
                                  // of what really..
                                  mw_routing = static_cast<MW::Routing>(static_cast<int>(v));
                                  ;
                              }}},
